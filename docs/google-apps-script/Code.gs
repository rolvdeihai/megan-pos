...
/**
 * Handle CORS preflight - returning empty response
 * CORS headers are handled by GAS Web App deployment settings
 */
 ...
 * Note: CORS headers are automatically handled by GAS Web App deployment
 */
