...
function PaymentSuccessContent() {
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex items-center justify-center px-4 py-10">
      <div className="w-full max-w-xl rounded-2xl border border-green-200 bg-white p-8 shadow-sm">
        ...
        <h1 className="text-center text-2xl font-bold text-gray-900">Pembayaran Berhasil</h1>
        <p className="mt-2 text-center text-sm text-gray-600">
          Langganan Anda sudah aktif. Silakan lanjutkan mengelola bisnis Anda.
        </p>
        ...
        <p className="mt-4 text-center text-xs text-gray-500">
          {autoRedirectEnabled
            ? `Otomatis ke billing dalam ${secondsLeft} detik.`
